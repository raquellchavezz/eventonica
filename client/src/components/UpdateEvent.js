...
const UpdateEvent = (props) => {
  ...
  const handleTitleChange = (e) => {
    //not the event(which is our data)
    e.preventDefault(); //in order to see this function we have to call it
    let updateTitle = e.target.value; //we get the e target which is the value of the newTitle coming from the input type text field
    ...
    console.log(updateEvent.title); //this is making sure we are console.logging what the user enters for the title
  };
  ...
  const handleSubmit = (e) => {
    ...
    setUpdateEvent(updateEvent); //here is where you would set the whole event
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <input
        ...
        required
        value={updateEvent.title} //need state
      ...
      <input
        ...
        required
        value={updateEvent.location} //state
      ...
      <input
        type="date"
        id="add-event-date"
        value={updateEvent.eventtime} //state
